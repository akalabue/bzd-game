      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Label), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        updateAllSeats(users) {
          ...
          for (var _i = 1; _i < 4; _i++) {
            ...
            this.readyOk[_i].active = users[cur].userStatus.status == "READY";
          }
        }
          ...
          if (isRight) {
            ...
            if (curSeat == this.pushcardVo.preSeat) {
              ...
              if (this.pushcardVo.preSeat == this.pushcardVo.prePushSeat) {
                ...
                for (var _i3 = 0; _i3 < cardList.length; _i3++) {
                  var pk = this.pokerAtlas.getSpriteFrame(cardList[_i3] + "");
              ...
              if ((this.pushcardVo.preSeat + 1) % 4 == curSeat) {
                for (var _i4 of this.cardSet) {
                  var _cardName2 = "card" + _i4;
                ...
                if (this.pushcardVo.myStatus == "PLAYING") {
                  ...
                  globalThis._BZDClient.sendMessage("END", {
                    pushCardsInfo: JSON.stringify(this.pushcardVo)
                  });
                  ...
                  globalThis._BZDClient.sendMessage("OVER", {
                    pushCardsInfo: JSON.stringify(this.pushcardVo)
                  });
        ...
        cleanPushCards(i) {
          ...
          for (var _i5 = 0; _i5 < 27; _i5++) {
            var cardName = "card" + _i5;
...
//# sourceMappingURL=da3907415f4cb72e0dc83e84095a7c816303107e.js.map