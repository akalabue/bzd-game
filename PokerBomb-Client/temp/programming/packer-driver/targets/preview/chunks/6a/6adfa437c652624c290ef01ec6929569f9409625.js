  ...
  return {
    ...
    execute: function () {
      ...
      _export("HallClient", HallClient = (_dec = ccclass('HallClient'), _dec(_class = class HallClient extends Component {
        ...
        _connectServer() {
          var ws = new WebSocket("ws:127.0.0.1:9091/websocket/hall");
          this._ws = ws;
          ...
          ws.onmessage = result => {
            ...
            var _data = obj.data;
            var _type = obj.type; // console.log("服务端发送数据--> 类型：", _type, " 数据：", _data)
...
//# sourceMappingURL=6adfa437c652624c290ef01ec6929569f9409625.js.map