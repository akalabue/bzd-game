System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, SpriteAtlas, resources, Sprite, director, tween, Vec3, PushCardVo, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _crd, ccclass, property, BZDSceneMgt;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Label), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        constructor() {
          super(...arguments);
        ...
        onPushCards(data) {
          ...
          if (isRight) {
            ...
            if (curSeat == this.pushcardVo.preSeat) {
              ...
              for (var i of cards) {
                var cardName = "card" + i;
                var cardName1 = "card" + j;
                var cardNode = this.pokerView.getChildByName(cardName);
                var cardNode1 = this.pushCardsView[0].getChildByName(cardName1);
                var p = cardNode.getPosition();
                var p1 = cardNode1.getPosition();
                cardNode1.setPosition(p);
                var pk = this.pokerAtlas.getSpriteFrame(cardList[j] + "");
                var sp = cardNode1.getComponent(Sprite);
                sp.spriteFrame = pk;
                cardNode.active = false;
                cardNode1.active = true; // tween(cardNode).to(0.8,{position: new Vec3(x,90,0)}).start();

                tween(cardNode1).to(0.8, {
                  position: p1
                }).start(); // x += d_x;
              } // this.cardSet.clear();
              ...
              if (this.pushcardVo.preSeat == this.pushcardVo.prePushSeat) {
                ...
                for (var _i3 = 0; _i3 < _cardList.length; _i3++) {
                  var _pk = this.pokerAtlas.getSpriteFrame(_cardList[_i3] + "");

                  var _cardName = "card" + _i3;

                  var _cardNode = pushCardsView.getChildByName(_cardName);

                  var _sp = _cardNode.getComponent(Sprite);
...
//# sourceMappingURL=a7b655eab5f6e4ab5104337e8a6b963dac0a626d.js.map