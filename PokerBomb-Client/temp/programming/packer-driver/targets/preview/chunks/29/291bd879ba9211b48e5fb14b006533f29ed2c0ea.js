    ...
    execute: function () {
      ...
      _export("joinRoom", joinRoom = (_dec = ccclass('joinRoom'), _dec2 = property(Label), _dec(_class = (_class2 = class joinRoom extends Component {
        ...
        onInputEvent(target, args) {
          ...
          for (var i = 0; i < 6; i++) {
            console.log(this.showLabel[i].string);
          }

          if (args == '清空') {
            this.str = '';

            for (var _i = 0; _i < this.cnt; _i++) {
              this.showLabel[_i].string = '-';
            }
...
//# sourceMappingURL=291bd879ba9211b48e5fb14b006533f29ed2c0ea.js.map