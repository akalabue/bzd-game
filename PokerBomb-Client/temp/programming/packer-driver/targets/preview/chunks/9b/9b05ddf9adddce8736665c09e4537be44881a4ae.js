      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Label), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        onDealCards(data) {
          ...
          for (var i = 0; i < 4; i++) {
            ...
            for (var _i2 = 0; _i2 < 27; _i2++) {
              var cardName = "card" + _i2;
        ...
        onPushCards(data) {
          ...
          if (isRight) {
            ...
            if (curSeat == this.pushcardVo.preSeat) {
              ...
              var seat = this.pushcardVo.preSeat;

              if (seat == this.pushcardVo.prePushSeat) {
                var pushCardsView = this.pushCardsView[seat];
                var cardList = this.pushcardVo.preCardList;

                for (var _i4 = 0; _i4 < cardList.length; _i4++) {
                  var pk = this.pokerAtlas.getSpriteFrame(this.cardList[_i4] + "");

                  var _cardName = "card" + _i4;
...
//# sourceMappingURL=9b05ddf9adddce8736665c09e4537be44881a4ae.js.map