System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, assetManager, SpriteAtlas, Prefab, instantiate, resources, Sprite, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, BZDSceneMgt;
    ...
    execute: function () {
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        onDealCards(data) {
          ...
          this.gameBundle = assetManager.getBundle("resources");
          resources.load("image/games/bazhadan/card/pokerlist", SpriteAtlas, (err, spriteFrames) => {
            if (err) console.log("load atlas err: ", err);else {
              this.pokerAtlas = spriteFrames;
          ...
          resources.load("image/games/bazhadan/PokerView", Prefab, (err, prefab) => {
            if (err) console.log("load prefab err: ", err);else {
              ...
              var pk = this.pokerAtlas.getSpriteFrame("103");
              var sp = poker.getComponent(Sprite);
              sp.spriteFrame = pk;
            }
          });
        }
...
//# sourceMappingURL=eec26d3a4d5ee96581c57422ab04dcba8bd55237.js.map