  ...
  return {
    ...
    execute: function () {
      ...
      _export("HallClient", HallClient = (_dec = ccclass('HallClient'), _dec(_class = class HallClient extends Component {
        ...
        _connectServer() {
          var ws = new WebSocket("ws:" + window.location.hostname + ":9091/websocket/hall/" + globalThis._userInfo.user_id);
          this._ws = ws;
...
//# sourceMappingURL=99c3923ba4cc6bf4bc67829912d6e9f5978032dd.js.map