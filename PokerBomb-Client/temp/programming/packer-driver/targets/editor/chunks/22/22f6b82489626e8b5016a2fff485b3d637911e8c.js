      ...
      _export("createRoom", createRoom = (_dec = ccclass('createRoom'), _dec(_class = class createRoom extends Component {
        ...
        onCreateBtnClicked() {
          ...
          let data = {
            ...
            scoreNumbers: this.scoreNumbers
          };
          console.log('创建房间信息：', data); // globalThis._hallClientMgr.sendMessage("createRoom", data);
        } //局数选择
...
//# sourceMappingURL=22f6b82489626e8b5016a2fff485b3d637911e8c.js.map