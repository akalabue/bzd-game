  ...
  return {
    ...
    execute: function () {
      ...
      _export("HallClient", HallClient = (_dec = ccclass('HallClient'), _dec(_class = class HallClient extends Component {
        ...
        _connectServer() {
          const ws = new WebSocket(`ws:127.0.0.1:9091/websocket/hall/${globalThis._userInfo.user_id}`);
          this._ws = ws;
          ...
          ws.onmessage = result => {
            ...
            let _data = obj.data;
            let _type = obj.type; // console.log("服务端发送数据--> 类型：", _type, " 数据：", _data)
...
//# sourceMappingURL=23f03a9ace148629e4d0ba551a6734ae49f0e853.js.map