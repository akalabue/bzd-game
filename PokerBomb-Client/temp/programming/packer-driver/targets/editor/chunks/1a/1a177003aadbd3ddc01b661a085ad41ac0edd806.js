System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, director, PokerCtr, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, BZDSceneMgt;
  ...
  function _reportPossibleCrUseOfPokerCtr(extras) {
    _reporterNs.report("PokerCtr", "./PokerCtr", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PokerCtr = _unresolved_2.PokerCtr;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        onDealCards(data) {
          ...
          let cards = data.cardList[globalThis._userInfo.room_seat]; // this.node.addComponent(Poker).init(cards);

          let pokerCtl = new (_crd && PokerCtr === void 0 ? (_reportPossibleCrUseOfPokerCtr({
            error: Error()
          }), PokerCtr) : PokerCtr)();
          pokerCtl.init(cards);
        }
...
//# sourceMappingURL=1a177003aadbd3ddc01b661a085ad41ac0edd806.js.map