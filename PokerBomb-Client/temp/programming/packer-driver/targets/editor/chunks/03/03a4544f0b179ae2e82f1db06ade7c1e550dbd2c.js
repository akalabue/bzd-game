System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, director, HallSoundMgt, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, HallSceneMgt;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("HallSceneMgt", HallSceneMgt = (_dec = ccclass('HallSceneMgt'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(_crd && HallSoundMgt === void 0 ? (_reportPossibleCrUseOfHallSoundMgt({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "hallSoundMgt", _descriptor5, this);
        }
        ...
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "hallSoundMgt", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=03a4544f0b179ae2e82f1db06ade7c1e550dbd2c.js.map