        ...
        onPushCards(data) {
          ...
          if (isRight) {
            ...
            if (curSeat == this.pushcardVo.preSeat) {
              ...
              for (let i of cards) {
                let cardName = "card" + i;
                let cardName1 = "card" + j;
                let cardNode = this.pokerView.getChildByName(cardName);
                let cardNode1 = this.pushCardsView[0].getChildByName(cardName1);
                let p = cardNode.getPosition();
                let p1 = cardNode1.getPosition();
                cardNode1.setPosition(p);
                let pk = this.pokerAtlas.getSpriteFrame(cardList[j] + "");
                let sp = cardNode1.getComponent(Sprite);
                sp.spriteFrame = pk;
...
//# sourceMappingURL=a5824db46ab37718614426f1168fb1f78f56d8b9.js.map