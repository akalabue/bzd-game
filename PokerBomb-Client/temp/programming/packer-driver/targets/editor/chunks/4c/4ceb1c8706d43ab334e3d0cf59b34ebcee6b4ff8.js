  ...
  return {
    ...
    execute: function () {
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        onRequestRoomInfo(data) {// this.roomId.string = data.roomId;
          // this.gamecount.string = data.currentNumbers + "/" + data.gameNumbers;
        }
...
//# sourceMappingURL=4ceb1c8706d43ab334e3d0cf59b34ebcee6b4ff8.js.map