  ...
  return {
    ...
    execute: function () {
      ...
      _export("BZDClient", BZDClient = (_dec = ccclass('BZDClient'), _dec(_class = class BZDClient extends Component {
        ...
        _connectServer() {
          const ws = new WebSocket(`ws:127.0.0.1:9091/websocket/bzd/${globalThis._userInfo.user_id}`);
          this._ws = ws;
...
//# sourceMappingURL=c96431f992f45e2430d7205fc1cfea1517e681fc.js.map