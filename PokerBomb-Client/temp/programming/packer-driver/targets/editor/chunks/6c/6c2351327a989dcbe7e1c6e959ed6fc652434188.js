System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, SpriteAtlas, resources, Sprite, director, tween, Vec3, PushCardVo, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _crd, ccclass, property, BZDSceneMgt;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Label), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "readyBtn", _descriptor9, this);

          _initializerDefineProperty(this, "cancelReadyBtn", _descriptor10, this);

          _initializerDefineProperty(this, "startBtn", _descriptor11, this);

          _initializerDefineProperty(this, "pokerView", _descriptor12, this);

          _initializerDefineProperty(this, "passBtn", _descriptor13, this);

          _initializerDefineProperty(this, "pushCardBtn", _descriptor14, this);

          _initializerDefineProperty(this, "paiPoints", _descriptor15, this);
        ...
        onPushCards(data) {
          ...
          if (isRight) {
            ...
            if (curSeat == this.pushcardVo.preSeat) {
              ...
              let cardList = this.pushcardVo.preCardList; //如果下家是我
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "readyBtn", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "cancelReadyBtn", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
        ...
        writable: true,
        initializer: null
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "pokerView", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "passBtn", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "pushCardBtn", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "paiPoints", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=6c2351327a989dcbe7e1c6e959ed6fc652434188.js.map