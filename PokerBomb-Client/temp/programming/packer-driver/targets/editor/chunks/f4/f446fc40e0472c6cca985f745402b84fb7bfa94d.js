  ...
  return {
    ...
    execute: function () {
      ...
      _export("BZDClient", BZDClient = (_dec = ccclass('BZDClient'), _dec(_class = class BZDClient extends Component {
        ...
        _connectServer() {
          const ws = new WebSocket(`ws:127.0.0.1:9091/websocket/bzd/${globalThis._userInfo.room_id}/${globalThis._userInfo.user_id}`);
          this._ws = ws;
...
//# sourceMappingURL=f446fc40e0472c6cca985f745402b84fb7bfa94d.js.map