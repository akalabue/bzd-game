System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, SpriteAtlas, resources, Prefab, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PokerCtr;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PokerCtr", PokerCtr = (_dec = ccclass('PokerCtr'), _dec2 = property(Prefab), _dec(_class = (_class2 = class PokerCtr extends Component {
        constructor(...args) {
          super(...args);
        ...
        showPoker() {// this.pokerView.active = true;
          // for(let i = 0; i < 7; i++){
...
//# sourceMappingURL=b470a0d2fc846a51206d8326910c559e25b28f44.js.map