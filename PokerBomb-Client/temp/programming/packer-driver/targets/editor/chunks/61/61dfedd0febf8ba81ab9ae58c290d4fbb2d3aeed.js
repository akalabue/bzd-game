    ...
    execute: function () {
      ...
      _export("BZDSceneMgt", BZDSceneMgt = (_dec = ccclass('BZDSceneMgt'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class BZDSceneMgt extends Component {
        ...
        init() {
          ...
          globalThis._eventtarget.on("requestRoomInfo", this.onRequestRoomInfo, this); // globalThis._eventtarget.on("dealCards", this.onDealCards, this);
        ...
        //     // this.node.addComponent(Poker).init(cards);
...
//# sourceMappingURL=61dfedd0febf8ba81ab9ae58c290d4fbb2d3aeed.js.map