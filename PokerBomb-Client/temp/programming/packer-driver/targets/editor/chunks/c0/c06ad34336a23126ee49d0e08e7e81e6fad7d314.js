System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Label, director, HallSoundMgt, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, HallSceneMgt;
    ...
    execute: function () {
      ...
      _export("HallSceneMgt", HallSceneMgt = (_dec = ccclass('HallSceneMgt'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(_crd && HallSoundMgt === void 0 ? (_reportPossibleCrUseOfHallSoundMgt({
        ...
        init() {
          ...
          this.nameLabel.string = globalThis._userInfo.user_name; // this.nameLabel.string = globalThis.vxUserInfo.nickName;
...
//# sourceMappingURL=c06ad34336a23126ee49d0e08e7e81e6fad7d314.js.map