  ...
  return {
    ...
    execute: function () {
      ...
      _export("LoginScence", LoginScence = (_dec = ccclass('LoginScence'), _dec2 = property(Node), _dec(_class = (_class2 = class LoginScence extends Component {
        ...
        start() {
          globalThis._eventtarget.on('login', this.onLoginMessage, this); // let sysInfo = wx.getSystemInfoSync();
          // //获取微信界面大小
...
//# sourceMappingURL=371dc1560fe2c9d0c7ec2c267a2c414dac9370b4.js.map